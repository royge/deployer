...
# Download terraform
RUN wget --no-check-certificate https://releases.hashicorp.com/terraform/0.11.12/terraform_0.11.12_linux_amd64.zip

# Extract terraform
RUN unzip terraform_0.11.12_linux_amd64.zip
...
# Clean up
RUN rm terraform_0.11.12_linux_amd64.zip
